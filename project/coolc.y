...
%token <node> LETTER
%token CLASS BLOCKSTART BLOCKOVER ITEMSTART ITEMOVER SYNTAX_OVER TYPE_ID IDENTIFIER_ID DOT DEFINE 
%token INHERITS SELF_TYPE ASSIGN BOOLEAN IF THEN ELSE FI NOT WHILE LOOP CASE POOL OF ESAC DO NEW ISVOID
%token LET IN END OPERATOR DIGIT NEXT AT INT_COMP SELF
...
expr    :   IDENTIFIER_ID       {printf("expr 1 ");}
        ...
        |   LETTER              {printf("expr 4 ");LetterList[0] = $1}
        |   SELF                {printf("expr 5 ");}
